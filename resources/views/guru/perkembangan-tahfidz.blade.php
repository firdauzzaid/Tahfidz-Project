...
@section('title', 'Perkembangan Tahfidz')
...
@section('content')
    ...
    <div class="row">
        <!-- Form Perkembangan Tahfidz -->
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h3>Perkembangan Tahfidz</h3>
                    @if(!session('nilaiId'))
                    <form action="/simpan-perkembangan-tahfidz" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="juz" name="id_juz">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="surah" name="id_surah" required>
                    ...
                    <form action="/simpan-data-lanjutan-ptahfidz" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="grupCabangTahfidz" class="form-label">Kelas</label>
                        ...
                        <button type="submit" class="btn btn-primary">Submit</button>
                        <a href="{{ route('guru.tambahDataAwalPTahfidz') }}" class="btn btn-secondary">Data Baru</a>
                    </form>
                    @endif
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <h3 class="p-3 text-center">Daftar Siswa - Perkembangan Tahfidz</h3>
                <div class="d-flex flex-row justify-content-center align-items-center mb-4">
                    <a href="/cetak-data-perkembangan-tahfidz" class="btn btn-primary">Cetak Data Perkembangan Tahfidz</a>
                </div>
                                    ...
                                    <div class="modal fade" id="modalHapusData{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="/hapus-perkembangan-tahfidz/{{ $item->id }}"
                                                    method="POST">
                                                    @csrf
