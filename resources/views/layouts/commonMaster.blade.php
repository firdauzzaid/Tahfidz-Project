...
<head>
    ...
    <title>@yield('title') | {{ $dataWeb['nama_website'] }}
    </title>
    <meta name="description" content="{{ $dataWeb['deskripsi_website'] }}" />
    <meta name="keywords" content="{{ $dataWeb['keyword_website'] }}">
    <!-- laravel CRUD token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- Canonical SEO -->
    <link rel="canonical" href="{{ config('variables.productPage') ? config('variables.productPage') : '' }}">
    <!-- Favicon -->
    <link rel="icon" type="image/jpeg" href="{{ $dataWeb['logo_website'] }}" />
