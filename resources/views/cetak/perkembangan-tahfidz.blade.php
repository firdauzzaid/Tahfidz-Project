...
@section('content')
        ...
        <div class="col-12">
            <div class="row mb-3">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="GET" action="{{ route('cetak.perkembangan-tahfidz') }}">
                                <div class="row">
                                    <!-- Pilih Bulan -->
                                    <div class="col-md-4">
            ...
            <div id="cetakData" class="card">
                <h3 class="p-3" style="text-align:center;">Laporan Perkembangan Tahfidz</h3>
    ...
    <script>
        function printCetakData() {
            ...
            printWindow.document.write('<html><head><title>Laporan Perkembangan Tahfidz</title>');
